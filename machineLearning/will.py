...
USUARIO_ID = ObjectId("6803a9680fefc0d68bdceb1e")  # ID del usuario admin
PROVEEDOR_ID = ObjectId("6803f82a19b203dfd565424d")  # ID del proveedor TottoColombia
ALMACEN_ID = ObjectId("6803f83619b203dfd565426f")  # ID del almacén Centro
...
if __name__ == "__main__":
    try:
        ...
        with open("tecnoWeb.productosw.json", "r", encoding="utf-8") as file:
